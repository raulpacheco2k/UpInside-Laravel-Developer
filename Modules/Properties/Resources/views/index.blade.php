                    ...
                    @foreach($properties as $property)
                        <div class="realty_list_item mt-1 mb-1">
                            ...
                            <div class="realty_list_item_content">
                                <h4>#{{ $property->id }} {{ \Modules\Properties\Models\PropertyTypes::getLabel($property->type) }} -
                                    {{ $property->address->neighborhood }}</h4>
                                ...
                                <div class="realty_list_item_card">
                                    ...
                                    <div class="realty_list_item_card_content">
                                        ...
                                        <span class="realty_list_item_description_content">{{ $property->address->neighborhood }}</span>
                                    </div>
                                </div>
                                ...
                                <div class="realty_list_item_card">
                                    ...
                                    <div class="realty_list_item_card_content">
                                        ...
                                        <span class="realty_list_item_description_content">{{ $property->bedrooms }} Quartos<br><span>Sendo 1 suítes</span></span>
                                    </div>
                                </div>
                                ...
                                <div class="realty_list_item_card">
                                    ...
                                    <div class="realty_list_item_card_content">
                                        ...
                                        <span class="realty_list_item_description_content">{{ $property->garage }} Vagas<br><span>Sendo {{ $property->garage_covered }} cobertas</span></span>
                                    </div>
                                </div>
